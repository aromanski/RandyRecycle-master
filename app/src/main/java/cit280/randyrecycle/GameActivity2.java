...
public class GameActivity2 extends AppCompatActivity implements View.OnTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //loading image views for falling objects Graydon/Aaron/Stuart/Sam (OPTIONAL)
        ...
        posmagY = 1200;
        //timer value for level Graydon/Nick
        timerValue = (TextView) findViewById(R.id.timerValue);

        //label textviews for score and health Graydon/Stuart
        ...
        disp.getSize(size);
        //set screen height/width based on above
        screenWidth = size.x;
        screenHeight = size.y;
